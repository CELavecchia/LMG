% Meshing the vertebrae. Initially, the surface meshes are obtained, then
% using TetGen the solid meshes are exported. 
% [Lmes] = FU_whole_model_gui(stl) : if stl =1, save the stl


function [Lmes] = meshing_vertebrae(stl)
%%
