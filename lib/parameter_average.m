function [dimensions] = parameter_average(age, height,sex);
...
%EPWu_half, EPDu,EPWi_half, EPDi, hL, PDH, PDW,TP_wi,Tp_w,SCD,SCW,lam_l, IVD
dimensions = struct('IVD',IVD,'EPWu_half',EPWu_half,'EPDu',EPDu, 'EPWi_half', ...
    'PWi_half,'EPDi',EPDi,'hL',hL,'PDH',PDH,'PDW',PDW,'TP_wi',TP_wi,'TP_w',...
    TP_w,'SCD',SCD,'SCW',SCW,'lam_l',lam_l);
