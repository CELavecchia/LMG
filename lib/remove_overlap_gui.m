...
function [L_body, L_proc, L_ped, lam_new] =...
   remove_overlap_gui(L_body, L_proc_grid_nt, L_ped_nt,L_lam_nt,...
...
[L_body,L_proc, L_ped, L_lam] = position_posterior_el_gui(L_body,L_lam_nt,L_proc_grid_nt,L_ped_nt,...
    EPWu_half, EPDu, hL,lam_l, sc_d, sc_w, PDW, PDH, TP_wu, TP_wi);
%{
...
%check IVD dimensions

%[anulus, nucleus] = change_IVD_dimensions(  EPWu_half, EPDu,IVD,anulus,nucleus);
